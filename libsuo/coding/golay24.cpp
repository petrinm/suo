...
/****** START OF SUO MODIFICATION *********/
// Remove the volk dependency to make the code easier to compile.
//#include <volk/volk.h>
#define volk_32u_popcnt(ret, val)  *(ret) = __builtin_popcountl(val)
/******* END OF SUO MODIFICATIONS *********/
